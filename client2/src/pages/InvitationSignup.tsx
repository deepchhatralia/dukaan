...
const InvitationSignup = () => {
    ...
    const signIn = () => {
        ...
        axios.post(`${BACKEND_URL}/staff/verifyToken`, { fname, lname, password, cpassword, token }, {
            headers: {
                'Authorization': token
            }
        }).then(val => {
                ...
                <div className='row'>
                    <div className='col-md-6'>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="col-sm-10">
                                <input value={lname} onChange={e => setLame(e.target.value)} type="text" className="form-control" id="lname" />
                            </div>
                        </div>
                        <div className="mb-3">
