...
const sendResetLink = async (ctx) => {
  ...
  await updateInvitedStaff(
    { email },
    { $set: { expiresIn: Date.now() + 3600000 } },
    { upsert: true }
  );
