...
import { changeProductQuantity, findOrders, insertOrder, updateOrder } from "../mongodb/order";
...
const getMerchantOrder = async (ctx) => {
    ...
    const filter = { _id: new ObjectId(order_id), store_id: new ObjectId(store_id) }
...
const getCustomerOrder = async (ctx) => {
    ...
    const filter = { _id: new ObjectId(order_id), customer_id: new ObjectId(customer_id), store_id: new ObjectId(store_id) }
...
const getAllCustomerOrders = async (ctx) => {
    ...
    const filter = { customer_id: new ObjectId(customer_id), store_id: new ObjectId(store_id) }
...
export { getMerchantOrder, getAllMerchantOrders, changeOrderStatus, getAllCustomerOrders, placeOrder }